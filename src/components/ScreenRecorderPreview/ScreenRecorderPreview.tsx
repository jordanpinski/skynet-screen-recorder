...
export const ScreenRecorderPreview: FC<IScreenRecorderPreview> = ({ blobUrl, recordings, resetRecording, setRecordings }) => {
    ...
    <div className="screen-recorder-preview">
      <div className="video-wrapper">
        ...
        <div className="video-actions">
          <button className="button button--primary" onClick={handleSaveRecording} title="Save Video">{loading ? "Saving, Please Wait.." : "Save Video"}</button>
